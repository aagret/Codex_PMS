...
source("/home/Alexandre/PMS/R/test/codex/cfg_quintet.R")
source("/home/Alexandre/PMS/R/test/codex/types_quintet.R")
source("/home/Alexandre/PMS/R/test/codex/load_quintet.R")
...
provider_schema <- tolower(Sys.getenv("PMS_SCHEMA", "quintet"))
...
quintet_datasets <- build_quintet_datasets(cfg, base_dir = base_dir)
...
ensure_tables_from_datasets(con, quintet_datasets, cfg, provider_schema)
upsert_all(con, quintet_datasets, cfg, schema = provider_schema)
