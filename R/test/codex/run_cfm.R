...
source("/home/Alexandre/PMS/R/test/codex/cfg_cfm.R")
source("/home/Alexandre/PMS/R/test/codex/types_cfm.R")
source("/home/Alexandre/PMS/R/test/codex/load_cfm.R")
...
cfm_datasets <- build_cfm_datasets(cfg, base_dir = base_dir)
...
ensure_tables_from_datasets(con, cfm_datasets, cfg, provider_schema)
upsert_all(con, cfm_datasets, cfg, schema = provider_schema)
